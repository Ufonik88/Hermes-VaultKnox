...
# NOTE: the header literal is assembled from two adjacent strings so this
# detector DEFINITION does not itself contain a contiguous private-key block
# header (secret scanners flag the file otherwise).
_register(
